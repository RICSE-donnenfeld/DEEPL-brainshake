...
from .ModelWeightsInit import init_weights_xavier_normal
...
class EpilepsyLSTM(nn.Module):
    ...
    def __init__(self, inputmodule_params, net_params, outmodule_params):
        ...
        self.lstm = nn.LSTM(
            input_size=n_nodes,  # the number of expected features (out of convs)
        ...
        self.fc = nn.Sequential(
            nn.Linear(hidden_size, hd), nn.ReLU(), nn.Linear(hd, n_classes)
        )
